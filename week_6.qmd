...
In the lecture, we were encouraged not to just present a study that classifies the imagery, but also think about how the data may be used. In this case, this classification may be useful for restoring the forests; at the national scale the Australian government has announced the initial investment of \$50 million for long-term protection and restoration following the Australian bushfires between 2019 and 2020 \[\], and this classification may inform which areas require the most immediate intervention.
